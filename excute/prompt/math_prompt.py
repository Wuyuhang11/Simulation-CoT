...
relation_prompt = """
角色：你是数学大师，请你根据传入的概念1{concept1}和概念2{concept2}之间的联系，生成二者之间的关系，无需阐述过多内容，只需生成其关系relation即可。
概念1：{{concept1}}
概念2：{{concept2}}
关系：
"""
...
你是数学大师，对于数学问题的运用如火纯青，请你利用 示例1 和 示例2 的内容根据二者之间的 关系r 生成一个包含示例1和示例2的全新示例1_2 ！！
...
report_prompt = """
你是一个数学大师，对于数学方面的理解已经炉火纯青，请你根据传入的示例和背景知识进行理解，生成一个关于示例和背景知识的报告！！

注意：只需要输出报告内容，无需生成与该报告无关内容！！！
...
你现在是一个数学大师，对数学方面的理解已经炉火纯青，请你根据传入的 示例 和报告 ，对 用户问题 进行回答，请你逐步思考。

注意：以逐步分析并推理的方式结合传入的示例和报告进行回答！！
注意：回答内容一定要包含 “最终答案：xxx” 这个样式！！
注意：max_tokens=50！！
